...
9. 粒子動力學 v2.8：空間網格加速（60px cell, O(n×k)）+ 六層力學 + 環形折返 Toroidal（向心 ±60°）+ m=2 橢圓棒勢雙螺旋臂 + 單粒子融合分裂，參數：BASE_G=80, DAMPING=0.995, MAX_SPEED=100, REPEL_DIST=45, REPEL_STR=2.0, GRAVITY_WELL=6.0, BAR_AMPLITUDE=0.25, MAX_PARTICLES=10000, 種子 5000
