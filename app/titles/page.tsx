      ...
      <div className="mx-auto max-w-6xl">
        ...
        {titles.length === 0 ? (
          <div className="rounded-2xl border border-gray-800 bg-gray-900/50 p-12 text-center">
            ...
            <p className="text-gray-700">No titles have been defined yet. Check back soon.</p>
          </div>
        ) : (
                        ...
                        >
                          ...
                          <div className={`relative ${isHidden ? 'opacity-90' : ''}`}>
                            <div className="mb-3 flex items-center gap-2">
                              ...
                              <h3 className={`text-lg font-bold ${isHidden ? 'text-gray-700' : 'text-gray-100'}`}>
                            ...
                            <p className={`text-sm leading-relaxed ${isHidden ? 'italic text-gray-700' : 'text-gray-400'}`}>
                              {isHidden
                            ...
                            {title.category && (
                              <div className="mt-4">
                                <span className={`inline-flex items-center gap-1 rounded-full border border-opacity-20 px-2.5 py-1 text-xs ${catCfg ? `${catCfg.color} ${catCfg.bg} border-current` : 'border-gray-700 bg-gray-800/50 text-gray-600'}`}>
