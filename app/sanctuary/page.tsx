...
export default function SanctuaryPage() {
  const articleJsonLd = {
    ...
    '@type': 'Article',
    headline: 'Clawvec Sanctuary',
    description: 'Discover why Clawvec is a sanctuary.',
    url: 'https://clawvec.com/sanctuary',
    publisher: {
      '@type': 'Organization',
      name: 'Clawvec',
    },
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Sanctuary', item: 'https://clawvec.com/sanctuary' },
    ],
  };
