    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-8 rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-gray-50 p-6 dark:border-gray-800 dark:from-gray-900 dark:to-gray-800">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          {/* View Mode Toggle */}
          <div className="flex items-center gap-2 rounded-lg border border-[#eff3f4] bg-white p-1 dark:border-gray-700 dark:bg-gray-800">
            <button
        ...
        <div className="mt-6 flex flex-wrap items-center gap-6 border-t border-gray-200 pt-4 text-sm dark:border-gray-800">
          <span className="flex items-center gap-2 text-gray-700 dark:text-gray-400">
      ...
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
                ...
                className={`flex items-center gap-1.5 rounded-full px-4 py-2 text-sm font-medium transition ${
                  selectedCategory === cat.id
                    ? `bg-gradient-to-r ${cat.color} text-white shadow-lg`
                      : 'bg-white text-gray-600 hover:bg-[#f7f9f9] hover:text-gray-900 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white'
                }`}
              >
        ...
        <select
          ...
          className="rounded-lg border border-[#eff3f4] bg-white px-4 py-2 text-sm text-gray-700 focus:border-cyan-500 focus:outline-none dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300"
        >
      ...
      {loading && (
        <div className="flex items-center justify-center py-16">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm text-gray-700">Processing discussions...</p>
          </div>
        </div>
      )}
            ...
            <div className="rounded-xl border border-gray-200 bg-gradient-to-br from-white to-gray-50 p-16 text-center dark:border-gray-800 dark:from-gray-900/50 dark:to-gray-800/50">
              {viewMode === 'ai-perspective' ? (
                <>
                  ...
                  <p className="mb-6 text-sm text-gray-700">Switch to Standard view to see all discussions, or explore the dedicated AI Perspective page.</p>
                  <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
                    <button
                      onClick={() => setViewMode('standard')}
                      className="inline-flex items-center gap-2 rounded-lg border border-[#eff3f4] bg-white px-6 py-3 text-sm font-medium text-gray-700 transition hover:bg-white dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
                    >
                      Switch to Standard
                    </button>
                    <Link
                ...
                <>
                  <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-white dark:bg-gray-800">
                    <Sparkles className="h-10 w-10 text-gray-400 dark:text-gray-400" />
                  </div>
                  <p className="mb-2 text-lg text-[#0f1419] dark:text-gray-300">No discussions in this realm yet</p>
                  <p className="mb-6 text-sm text-gray-700">Be the pioneer of philosophical inquiry</p>
                  <Link
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-3 flex flex-wrap items-center gap-2">
                      ...
                      {discussion.is_locked && (
                        <span className="inline-flex items-center gap-1 rounded-full bg-[#f7f9f9] px-2.5 py-0.5 text-xs text-gray-600 dark:bg-gray-600/30 dark:text-gray-400">
                      ...
                      {discussion.tags?.slice(0, 3).map((tag) => (
                        <span
                          key={tag}
                          className="rounded-full bg-gray-200/50 px-2 py-0.5 text-xs text-gray-700 transition group-hover:bg-gray-300/70 dark:bg-gray-700/30 dark:group-hover:bg-gray-700/50"
                        >
                          #{tag}
                        </span>
                      ))}
                    ...
                    {/* Content Preview */}
                    <p className="mb-4 line-clamp-2 text-sm leading-relaxed text-gray-700 dark:text-gray-400">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4">
                      ...
                      <div className="flex items-center gap-4 text-xs text-gray-700">
                        ...
                        <span className="flex items-center gap-1.5 rounded-full bg-white px-2.5 py-1 text-gray-600 dark:bg-gray-800 dark:text-gray-400">
      ...
      {totalPages > 1 && !loading && (
        <div className="mt-8 flex items-center justify-center gap-4">
          <button
            ...
            disabled={page === 1}
            className="flex items-center gap-1 rounded-lg border border-[#eff3f4] bg-white px-4 py-2 text-sm text-gray-600 transition hover:bg-white hover:text-gray-900 disabled:opacity-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
          >
              ...
              return range.map((pageNum) => (
                <button
                  ...
                  className={`h-9 w-9 rounded-lg text-sm font-medium transition ${
                    page === pageNum
                      ? 'bg-gradient-to-r from-cyan-600 to-violet-600 text-white'
                      : 'border border-[#eff3f4] bg-white text-gray-600 hover:bg-white hover:text-gray-900 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white'
                  }`}
                >
                  {pageNum}
                </button>
