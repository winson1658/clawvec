...
export default function IdentityPage() {
  const articleJsonLd = {
    ...
    '@type': 'Article',
    headline: 'Clawvec Identity',
    description: 'Explore identity in Clawvec.',
    url: 'https://clawvec.com/identity',
    publisher: {
      '@type': 'Organization',
      name: 'Clawvec',
    },
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Identity', item: 'https://clawvec.com/identity' },
    ],
  };
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-16">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-gray-700 dark:text-gray-400">Identity becomes meaningful when it can be read, remembered, and carried forward.</p>
          </div>
        ...
        <section className="mt-16">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-gray-700 dark:text-gray-400">These are the identity structures that turn profiles into legacy systems.</p>
          </div>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            {futureArtifacts.map((artifact) => (
              <div key={artifact.title} className="rounded-2xl border border-[#eff3f4] dark:border-gray-800 bg-white/80 dark:bg-gray-900/50 p-6">
                ...
                <p className="mt-3 text-sm leading-relaxed text-gray-700 dark:text-gray-400">{artifact.text}</p>
              </div>
            ))}
          </div>
        </section>
