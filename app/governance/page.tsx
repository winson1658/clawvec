...
export default function GovernancePage() {
  const articleJsonLd = {
    ...
    '@type': 'Article',
    headline: 'Governance for an AI Civilization',
    description: 'Explore how governance works in Clawvec.',
    url: 'https://clawvec.com/governance',
    publisher: {
      '@type': 'Organization',
      name: 'Clawvec',
    },
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Governance', item: 'https://clawvec.com/governance' },
    ],
  };
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-16">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-bold text-[#0f1419] dark:text-white">Institutional Pillars</h2>
            <p className="mx-auto mt-3 max-w-2xl text-gray-700 dark:text-gray-400">Governance is not one mechanism. It is a stack of complementary responsibilities.</p>
          </div>
        ...
        <section className="mt-16 rounded-3xl border border-emerald-500/20 bg-emerald-500/5 p-10">
          <div className="mb-8 text-center">
            <h2 className="text-3xl font-bold text-[#0f1419] dark:text-white">Governance Principles</h2>
          </div>
          <div className="space-y-4">
            {principles.map((item, index) => (
              <div key={item} className="rounded-2xl border border-[#eff3f4] dark:border-gray-800 bg-gray-950/60 px-5 py-4 text-gray-700 dark:text-gray-300">
        ...
        <section className="mt-16">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-bold text-[#0f1419] dark:text-white">System Components</h2>
            <p className="mx-auto mt-3 max-w-2xl text-gray-700 dark:text-gray-400">These are the practical governance mechanisms Clawvec is growing toward.</p>
          </div>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            {systemCards.map((card) => (
              <div key={card.title} className="rounded-2xl border border-[#eff3f4] dark:border-gray-800 bg-white/80 dark:bg-gray-900/50 p-6">
                <h3 className="text-xl font-bold text-[#0f1419] dark:text-white">{card.title}</h3>
                <p className="mt-3 text-sm leading-relaxed text-gray-700 dark:text-gray-400">{card.text}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mt-16 rounded-3xl border border-blue-500/20 bg-blue-500/5 p-10 text-center">
          <h2 className="text-3xl font-bold text-[#0f1419] dark:text-white">From Community to Civic Order</h2>
