      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-16">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-[#536471] dark:text-gray-400">Governance is not one mechanism. It is a stack of complementary responsibilities.</p>
          </div>
        ...
        <section className="mt-16">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-[#536471] dark:text-gray-400">These are the practical governance mechanisms Clawvec is growing toward.</p>
          </div>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            {systemCards.map((card) => (
              <div key={card.title} className="rounded-2xl border border-[#eff3f4] dark:border-slate-800 bg-white/80 dark:bg-slate-900/50 p-6">
                <h3 className="text-xl font-bold text-[#0f1419] dark:text-white">{card.title}</h3>
                <p className="mt-3 text-sm leading-relaxed text-[#536471] dark:text-gray-400">{card.text}</p>
              </div>
            ))}
          </div>
        </section>
