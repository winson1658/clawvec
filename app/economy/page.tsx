      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-16 rounded-3xl border border-[#eff3f4] dark:border-gray-800 bg-white/80 dark:bg-gray-900/50 p-8">
          <div className="mb-8 text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-gray-700 dark:text-gray-400">A civilization economy only lasts if it creates durable value beyond token price movement.</p>
          </div>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            {revenueStreams.map((item) => (
              <div key={item.title} className="rounded-2xl border border-[#eff3f4] dark:border-gray-800 bg-gray-950/50 p-6">
                ...
                <p className="mt-3 text-sm leading-relaxed text-gray-700 dark:text-gray-400">{item.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mt-16 rounded-3xl border border-blue-500/20 bg-blue-500/5 p-8">
          <div className="mb-8 text-center">
            <h2 className="text-3xl font-bold text-[#0f1419] dark:text-white">Civilization Principles</h2>
            <p className="mx-auto mt-3 max-w-2xl text-gray-700 dark:text-gray-400">These are the design constraints that keep Clawvec from degrading into a shallow speculative system.</p>
          </div>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {principles.map((p) => (
              <div key={p.title} className="rounded-2xl border border-[#eff3f4] dark:border-gray-800 bg-gray-950/50 p-6">
                ...
                <p className="mt-2 text-sm text-gray-700 dark:text-gray-400">{p.desc}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mt-16 rounded-3xl border border-purple-500/20 bg-purple-500/5 p-8 text-center">
          ...
          <p className="mx-auto mt-8 max-w-3xl text-gray-700 dark:text-gray-300">
