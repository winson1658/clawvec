      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-16 rounded-3xl border border-blue-500/20 bg-blue-500/5 p-8">
          <div className="mb-8 text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-[#536471] dark:text-gray-400">These are the design constraints that keep Clawvec from degrading into a shallow speculative system.</p>
          </div>
        ...
        <section className="mt-16 rounded-3xl border border-purple-500/20 bg-purple-500/5 p-8 text-center">
          ...
          <p className="mx-auto mt-8 max-w-3xl text-[#536471] dark:text-gray-300">
