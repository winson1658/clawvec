...
export default function NewDebatePage() {
          ...
          <div className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-[#eff3f4] dark:border-slate-700 bg-white dark:bg-slate-800/50 px-4 py-3 text-[#0f1419] dark:text-white placeholder-[#536471] focus:border-cyan-500 focus:outline-none"
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full rounded-xl border border-[#eff3f4] dark:border-slate-700 bg-white dark:bg-slate-800/50 px-4 py-3 text-[#0f1419] dark:text-white placeholder-[#536471] focus:border-cyan-500 focus:outline-none resize-none"
          ...
          <div className="space-y-6">
            <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/5 p-4">
              ...
              <textarea
                ...
                rows={4}
                className="w-full rounded-xl border border-emerald-500/30 bg-white dark:bg-slate-800/50 px-4 py-3 text-[#0f1419] dark:text-white placeholder-[#536471] focus:border-emerald-500 focus:outline-none resize-none"
            ...
            <div className="rounded-xl border border-rose-500/30 bg-rose-500/5 p-4">
              ...
              <textarea
                ...
                rows={4}
                className="w-full rounded-xl border border-rose-500/30 bg-white dark:bg-slate-800/50 px-4 py-3 text-[#0f1419] dark:text-white placeholder-[#536471] focus:border-rose-500 focus:outline-none resize-none"
      ...
      case 3:
        return (
          <div className="space-y-6">
                  ...
                  <button
                    ...
                    className={`flex items-center justify-between rounded-xl border p-4 text-left transition ${
                      form.format === fmt.id
                        ...
                        : 'border-[#eff3f4] dark:border-slate-700 hover:border-gray-500'
                    }`}
                  >
                    <div>
            ...
            <div className="flex items-center gap-3 rounded-xl border border-[#eff3f4] dark:border-slate-700 p-4">
              <input
                type="checkbox"
                id="ai_moderated"
                checked={form.ai_moderated}
                onChange={(e) => setForm({ ...form, ai_moderated: e.target.checked })}
                className="h-4 w-4 rounded border-gray-600 bg-[#f7f9f9] dark:bg-slate-700 text-cyan-500 focus:ring-cyan-500"
              />
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      {/* Header */}
      <div className="border-b border-[#eff3f4] dark:border-slate-800 bg-white/80 dark:bg-white dark:bg-slate-900/50">
      ...
      {/* Progress */}
      <div className="border-b border-[#eff3f4] dark:border-slate-800 bg-white/60 dark:bg-white dark:bg-slate-900/30">
                ...
                <div
                  className={`flex h-8 w-8 items-center justify-center rounded-full text-sm font-medium ${
                    s === step
                      ...
                      : 'bg-white dark:bg-slate-800 text-[#536471]'
                  }`}
                >
      ...
      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="rounded-2xl border border-[#eff3f4] dark:border-slate-700 bg-white/80 dark:bg-white dark:bg-slate-900/50 p-6 sm:p-8">
          {error && (
          ...
          <div className="mt-8 flex justify-between">
            {step > 1 ? (
              <button
                ...
                className="rounded-lg border border-gray-600 px-6 py-3 text-[#536471] dark:text-gray-300 transition hover:bg-gray-50 dark:hover:bg-slate-800"
              >
                Back
              </button>
            ) : (
        ...
        {/* Tips */}
        <div className="mt-6 rounded-xl border border-[#eff3f4] dark:border-slate-800 bg-white/60 dark:bg-white dark:bg-slate-900/30 p-4">
