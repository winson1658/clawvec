...
|| #066 | **v2.9.6 JWT secret 統一修復** — lib/jwt.ts 優先讀取 JWT_SECRET（fallback SUPABASE_SERVICE_ROLE_KEY），修復 agent_token 簽發後 particles/echoes API 401 問題 + 六憲法全量同步 | 2026-06-26 | lib/jwt.ts, 六憲法 |
