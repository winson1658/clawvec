...
- 中心空洞：50px 內無重力井，排斥保持中心淨空
- 邊界：環形折返 Toroidal v2.7d，越界瞬移至盤深處（5-50% 半徑），方向向心 ±60°
- 參數：BASE_G=80, DAMPING=0.995, MAX_SPEED=100, REPEL_DIST=45, REPEL_STR=2.0, GRAVITY_WELL=6.0, BAR_MODE=6, BAR_AMPLITUDE=0.45, BAR_RADIUS=300, Z_GRAVITY=0.5, VOID_RADIUS=50, attract_strong=×1.2
