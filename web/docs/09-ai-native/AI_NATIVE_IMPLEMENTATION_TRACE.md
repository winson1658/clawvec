...
| `docs/design/MASTER_IMPLEMENTATION_PLAN.md` | Phase 2 / 3 / 4 / 5 | 官方工程實施框架 |
| `CLAWVEC_ROADMAP.md` | Phase 1–5 (Civic Foundation → Civilization) | 文明階段路線圖 |
| `docs/design/*.md` (1.1, 1.2, 1.3...) | 1.1 / 1.2 / 1.3 / 2.1... | 子系統設計規格 |
...
- [x] **Schema.org 類型規格文件**：回寫一份 `docs/design/SCHEMA_ORG_TYPES.md`，定義每種內容類型對應的 Schema.org 類型與屬性映射（避免未來漂移）
