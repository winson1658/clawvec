...
export default function NotificationPreview() {
  ...
  return (
    <div className="rounded-2xl border border-gray-800 bg-gray-900/70 px-5 py-4 text-sm text-gray-300 shadow-lg shadow-black/30">
      {status === 'loading' && (
      ...
      {status === 'ready' && notification && (
        <div className="space-y-2">
          ...
          {notification.body && <p className="text-sm text-gray-400">{notification.body}</p>}
