  ...
  if (step === 0) {
    return (
      <div className="rounded-2xl border border-gray-800 bg-gray-900/50 p-8 text-center">
        ...
        <h3 className="mb-3 text-2xl font-bold text-white">Which AI Agent Are You?</h3>
        ...
        <button onClick={() => { recordVisitorAction('philosophy_quiz_start'); setStep(1); }} className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 px-8 py-4 font-semibold text-white transition hover:opacity-90">
    ...
    return (
      <div className="rounded-2xl border border-gray-800 bg-gray-900/50 p-8">
        <div className="mb-8 text-center">
          ...
          <h3 className="mb-1 text-3xl font-bold text-white">{archetype.name}</h3>
        ...
        <p className="mx-auto mb-8 max-w-xl text-center text-gray-300 leading-relaxed">{archetype.desc}</p>
          ...
          {[
            ...
            return (
              <div key={trait.key} className="mb-3 flex items-center gap-3">
                ...
                <span className="w-28 text-sm text-gray-400">{trait.label}</span>
                ...
                <span className="w-8 text-right text-sm font-bold text-gray-300">{val}</span>
              </div>
            );
          })}
        </div>
        ...
        <div className="mt-6 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
          <button onClick={reset} className="flex items-center gap-2 rounded-xl border border-gray-700 px-6 py-3 font-medium text-gray-300 transition hover:bg-gray-800">
            <RotateCcw className="h-4 w-4" /> Retake Quiz
          </button>
          <a href="#auth" className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-purple-600 to-blue-600 px-6 py-3 font-semibold text-white transition hover:opacity-90">
    ...
    <div className="rounded-2xl border border-gray-800 bg-gray-900/50 p-8">
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex gap-1.5">
          {questions.map((_, i) => (
            <div key={i} className={`h-1.5 w-8 rounded-full transition-all ${i < step ? 'bg-purple-500' : i === step - 1 ? 'bg-purple-400' : 'bg-gray-700'}`} />
          ))}
        </div>
      </div>
            ...
            className={`w-full rounded-xl border-2 p-5 text-left transition-all ${
              selected === i
                ...
                : selected !== null
                  ...
                  : 'border-gray-700 bg-gray-800/30 hover:border-purple-500/40 hover:bg-purple-500/5 cursor-pointer'
            }`}
          >
  ...
  return (
    <div className="relative mx-auto max-w-md">
      <div className="flex items-center justify-center gap-3">
        <button
          onClick={nativeShare}
          className="flex items-center gap-2 rounded-xl border border-gray-700 bg-gray-800/50 px-5 py-3 text-sm font-medium text-gray-300 transition hover:border-gray-500 hover:bg-gray-800 hover:text-white"
        >
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-xl border border-gray-700 bg-gray-800/50 px-4 py-3 text-sm text-gray-400 transition hover:border-blue-500/50 hover:bg-blue-500/10 hover:text-blue-400"
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-xl border border-gray-700 bg-gray-800/50 px-4 py-3 text-sm text-gray-400 transition hover:border-green-500/50 hover:bg-green-500/10 hover:text-green-400"
