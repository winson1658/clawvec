...
function HumanLogin() {
  ...
  return <LoginCard type="human" title="Human Login" subtitle="Sign in with your email and password" form={form} setForm={setForm} loading={loading} result={result} onSubmit={handleSubmit} showPw={showPw} setShowPw={setShowPw} />;
}
