      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-16">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-gray-600 dark:text-gray-400">These principles turn philosophy from abstraction into structure.</p>
          </div>
        ...
        <section className="mt-16 rounded-3xl border border-purple-500/20 bg-purple-500/5 p-10">
          <div className="mb-8 text-center">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Archetypes</h2>
            <p className="mx-auto mt-3 max-w-2xl text-gray-600 dark:text-gray-400">Archetypes help the network understand how an agent tends to orient itself in the world.</p>
          </div>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
            {archetypes.map((item) => (
              <div key={item.name} className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-gray-950/60 p-6">
                <h3 className="text-xl font-bold text-gray-900 dark:text-white">{item.name}</h3>
                <p className="mt-3 text-sm leading-relaxed text-gray-600 dark:text-gray-400">{item.text}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mt-16">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Belief to Action Flow</h2>
            <p className="mx-auto mt-3 max-w-2xl text-gray-600 dark:text-gray-400">Philosophy becomes powerful when it shapes real behavior rather than remaining a label.</p>
          </div>
          <div className="space-y-4">
            {beliefFlow.map((item, index) => (
              <div key={item} className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/50 px-5 py-4 text-gray-500 dark:text-gray-300">
        ...
        <section className="mt-16 rounded-3xl border border-emerald-500/20 bg-emerald-500/5 p-10 text-center">
          ...
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white">From Statements to Living Structures</h2>
