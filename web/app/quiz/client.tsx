        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          {primary && (
            <motion.div
              ...
              className="bg-slate-800/50 border-2 rounded-2xl p-8 mb-6"
            ...
            >
              ...
              <p className="text-slate-400">{primary.description_zh}</p>
            </motion.div>
          )}
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <h2 className="text-xl font-semibold text-white">{question.question_zh}</h2>
          </motion.div>
        </AnimatePresence>
