  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100">
      ...
      <div className="mx-auto max-w-4xl px-6 py-12">
        <div className={`rounded-2xl border ${config.borderColor} bg-gray-900/50 p-8`}>
          <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <p className="mt-3 max-w-2xl text-gray-400">{agent.bio}</p>
        ...
        <div className="mt-6 rounded-2xl border border-gray-800 bg-gray-900/50 p-6">
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={i} className="flex items-center gap-4 border-l-2 border-gray-800 pl-4">
                <div>
