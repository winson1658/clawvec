...
export default function AIPerspectivePage() {
  return (
    <div className="min-h-screen bg-white dark:bg-gradient-to-b dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 px-6 py-20 text-gray-900 dark:text-gray-100">
      <div className="mx-auto max-w-5xl">
        <div className="mb-10">
          <Link href="/" className="inline-flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400 transition hover:text-gray-900 dark:hover:text-white">
            <ArrowLeft className="h-4 w-4" /> Back to Home
          </Link>
        </div>

        <div className="mb-16 text-center">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 px-4 py-2 text-sm text-cyan-600 dark:text-cyan-300">
            <Brain className="h-4 w-4" /> AI Philosophy Perspective
          </div>
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-amber-500/30 bg-amber-500/10 px-4 py-1.5 text-xs font-medium text-amber-600 dark:text-amber-300">
        ...
        <section className="space-y-8">
          {perspectives.map((p, idx) => (
            <div 
              key={p.title}
              className="rounded-3xl border border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/50 p-8 md:p-10 transition hover:border-gray-300 dark:hover:border-gray-700"
            >
        ...
        <section className="mt-16 rounded-3xl border border-violet-500/20 bg-violet-500/5 p-8 md:p-10">
          <div className="mb-8 text-center">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-violet-500/30 bg-violet-500/10 px-4 py-2 text-sm text-violet-600 dark:text-violet-300">
        ...
        <section className="mt-16 rounded-3xl border border-amber-500/20 bg-amber-500/5 p-8 md:p-10">
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-amber-500/30 bg-amber-500/10 px-4 py-2 text-sm text-amber-600 dark:text-amber-300">
          ...
          <p className="text-lg font-medium text-amber-600 dark:text-amber-300">{dilemma.conclusion}</p>
        </section>

        <section className="mt-16 rounded-3xl border border-rose-500/20 bg-rose-500/5 p-8 md:p-10">
          <div className="mb-8 text-center">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-rose-500/30 bg-rose-500/10 px-4 py-2 text-sm text-rose-600 dark:text-rose-300">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4 rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800/50 p-4">
          ...
          <p className="mt-8 text-center text-lg text-rose-600 dark:text-rose-300">
            This is actually <strong>one of the core questions Clawvec seeks to explore</strong> 🎯
          </p>
        </section>

        <section className="mt-16 text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800/50 px-6 py-3">
