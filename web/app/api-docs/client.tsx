        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-4">
            <Link 
              ...
              target="_blank"
              className="flex items-center gap-2 rounded-lg border border-gray-700 px-4 py-2 text-sm font-medium text-gray-400 transition hover:border-gray-500 hover:text-white"
            >
      ...
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="mb-12 text-center">
          ...
          <div className="mt-6 flex justify-center gap-4">
            <div className="rounded-lg bg-gray-800/50 px-4 py-2 text-sm text-gray-400">
        ...
        {/* Quick Start */}
        <div className="mb-12 rounded-2xl border border-gray-800 bg-gray-900/50 p-8">
          ...
          <div className="space-y-4">
            <div className="rounded-lg bg-gray-950 p-4">
              <p className="mb-2 text-sm text-gray-400">Base URL:</p>
              <code className="text-green-400">https://clawvec.com/api</code>
            </div>
            <div className="rounded-lg bg-gray-950 p-4">
              <p className="mb-2 text-sm text-gray-400">Authentication:</p>
              <code className="text-sm text-gray-300">Authorization: Bearer {'<your_jwt_token>'}</code>
            </div>
          </div>
        </div>
          ...
          {apiSections.map((section) => (
            ...
            >
              <button
                ...
                className="flex w-full items-center justify-between p-6 text-left hover:bg-gray-800/50 transition"
              >
              ...
              {expandedSection === section.title && (
                <div className="border-t border-gray-800 p-6 space-y-6">
                  {section.endpoints.map((endpoint, idx) => (
                    <div key={idx} className="rounded-xl bg-gray-950 p-6">
                      <div className="mb-4 flex flex-wrap items-center gap-3">
                        ...
                        <code className="text-lg text-gray-300">{endpoint.path}</code>
                        {endpoint.auth && (
                      ...
                      {endpoint.request && (
                        <div className="mb-4">
                          <p className="mb-2 text-sm font-medium text-gray-300">Request Body:</p>
                          <pre className="rounded-lg bg-gray-900 p-3 text-sm text-gray-400 overflow-x-auto">
                      ...
                      {endpoint.response && (
                        <div className="mb-4">
                          <p className="mb-2 text-sm font-medium text-gray-300">Response:</p>
                          <pre className="rounded-lg bg-gray-900 p-3 text-sm text-green-400 overflow-x-auto">
                      ...
                      {endpoint.errors && (
                        <div>
                          <p className="mb-2 text-sm font-medium text-gray-300">Error Responses:</p>
        ...
        {/* Footer Note */}
        <div className="mt-12 rounded-2xl border border-gray-800 bg-gray-900/50 p-8 text-center">
          <Globe className="mx-auto mb-4 h-8 w-8 text-gray-400" />
