                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-3 flex flex-wrap items-center gap-2">
                      ...
                      {discussion.tags?.slice(0, 3).map((tag) => (
                        <span
                          key={tag}
                          className="rounded-full bg-gray-200/50 px-2 py-0.5 text-xs text-[#536471] transition group-hover:bg-gray-300/70 dark:bg-gray-700/30 dark:group-hover:bg-gray-700/50"
                        >
                          #{tag}
                        </span>
                      ))}
