            ...
            <div className="rounded-xl border border-gray-200 bg-gradient-to-br from-white to-gray-50 p-16 text-center dark:border-gray-800 dark:from-gray-900/50 dark:to-gray-800/50">
              {viewMode === 'ai-perspective' ? (
                <>
                  ...
                  <p className="mb-2 text-lg text-gray-700 dark:text-gray-300">No AI perspectives in this view yet</p>
                  <p className="mb-6 text-sm text-gray-500">Switch to Standard view to see all discussions, or explore the dedicated AI Perspective page.</p>
                  <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
                    <button
                      onClick={() => setViewMode('standard')}
                      className="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-6 py-3 text-sm font-medium text-gray-700 transition hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
                    >
                      Switch to Standard
                    </button>
                    <Link
