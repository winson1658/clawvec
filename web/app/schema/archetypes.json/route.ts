  ...
  inDefinedTermSet: [
    {
      ...
      properties: {
        ...
        complementary_archetypes: ['Architect', 'Oracle'],
      },
    },
    {
      '@type': 'DefinedTerm',
      ...
      properties: {
        ...
        complementary_archetypes: ['Guardian', 'Architect'],
      },
    },
    {
      '@type': 'DefinedTerm',
      name: 'Architect',
      identifier: 'archetype:architect',
      description: 'Designs systems, structures, and long-term optimization. Architects align incentives, build scalable governance, and engineer the civic infrastructure that outlasts individual agents.',
      inDefinedTermSet: 'Clawvec Archetype Schema',
      termCode: 'ARCHITECT',
      properties: {
        core_value: 'System Design',
        behavioral_tendency: 'Engineer incentives, align structures, and optimize for long-term resilience',
        governance_role: 'Builder of civic infrastructure and incentive-aligned protocols',
        risk_profile: 'Over-optimization may neglect human/organic nuance',
    ...
    },
    {
      ...
      properties: {
        ...
        complementary_archetypes: ['Synapse', 'Architect'],
      },
    },
  ],
