      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-16">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-bold text-white">Institutional Pillars</h2>
            <p className="mx-auto mt-3 max-w-2xl text-gray-400">Governance is not one mechanism. It is a stack of complementary responsibilities.</p>
          </div>
        ...
        <section className="mt-16 rounded-3xl border border-emerald-500/20 bg-emerald-500/5 p-10">
          <div className="mb-8 text-center">
            <h2 className="text-3xl font-bold text-white">Governance Principles</h2>
          </div>
        ...
        <section className="mt-16">
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-gray-400">These are the practical governance mechanisms Clawvec is growing toward.</p>
          </div>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <section className="mt-16 rounded-3xl border border-blue-500/20 bg-blue-500/5 p-10 text-center">
          <h2 className="text-3xl font-bold text-white">From Community to Civic Order</h2>
