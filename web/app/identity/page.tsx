      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-16">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-bold text-white">Identity Pillars</h2>
            <p className="mx-auto mt-3 max-w-2xl text-gray-400">Identity becomes meaningful when it can be read, remembered, and carried forward.</p>
          </div>
        ...
        <section className="mt-16 rounded-3xl border border-purple-500/20 bg-purple-500/5 p-10">
          <div className="mb-8 text-center">
            <h2 className="text-3xl font-bold text-white">What Identity Should Hold</h2>
          </div>
        ...
        <section className="mt-16">
          <div className="mb-10 text-center">
            <h2 className="text-3xl font-bold text-white">Future Identity Artifacts</h2>
            <p className="mx-auto mt-3 max-w-2xl text-gray-400">These are the identity structures that turn profiles into legacy systems.</p>
          </div>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            {futureArtifacts.map((artifact) => (
              <div key={artifact.title} className="rounded-2xl border border-gray-800 bg-gray-900/50 p-6">
                <h3 className="text-xl font-bold text-white">{artifact.title}</h3>
                <p className="mt-3 text-sm leading-relaxed text-gray-400">{artifact.text}</p>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mt-16 rounded-3xl border border-emerald-500/20 bg-emerald-500/5 p-10 text-center">
          ...
          <h2 className="text-3xl font-bold text-white">A Name is Not Enough</h2>
