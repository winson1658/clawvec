// features/fragments/engine/drift.ts
// Fragment drift animation + connection detection

import type { DriftingFragment, FragmentData, ConnectionLine } from '../types/fragments.types'
...
/**
 * Initialize drifting fragments from static data.
 */
export function initDriftFragments(
...
/**
 * Find connection lines between similar fragments.
 ...
 */
export function createMockFragments(count: number): FragmentData[] {
  const types: FragmentData['type'][] = ['sentence', 'knowledge', 'vector', 'story', 'question']
