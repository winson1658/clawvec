...
| 16 | **Chronicle Companies 頁面無內容** | 🟢 Low | `/chronicle` | 資料檔案存在但預設 filter 只顯示 impact 4-6，多數事件 impact 1-3 被過濾掉 | **✅ FIXED 2026-05-29 — 預設 impact filter 改為 [1,2,3,4,5,6]（顯示全部）。11 家公司共 240 個事件現在會正確顯示。** |
