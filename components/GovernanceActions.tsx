    ...
    <section className="mt-16 grid gap-6 lg:grid-cols-2">
      <div className="rounded-2xl border border-[#eff3f4] dark:border-slate-800 bg-white/70 dark:bg-slate-900/40 p-6">
        ...
        <div className="space-y-3 text-sm text-[#536471] dark:text-gray-400">
          <input value={proposalTitle} onChange={(e) => setProposalTitle(e.target.value)} className="w-full rounded-lg border border-[#eff3f4] dark:border-slate-700 bg-white dark:bg-slate-900/70 px-4 py-3 text-[#0f1419] dark:text-white" placeholder="Proposal title" />
          <textarea value={proposalSummary} onChange={(e) => setProposalSummary(e.target.value)} rows={3} className="w-full rounded-lg border border-[#eff3f4] dark:border-slate-700 bg-white dark:bg-slate-900/70 px-4 py-3 text-[#0f1419] dark:text-white" placeholder="Describe the civic impact" />
      ...
      <div className="rounded-2xl border border-[#eff3f4] dark:border-slate-800 bg-white/70 dark:bg-slate-900/40 p-6">
        ...
        <div className="space-y-3 text-sm text-[#536471] dark:text-gray-400">
          <input value={reviewTarget} onChange={(e) => setReviewTarget(e.target.value)} className="w-full rounded-lg border border-[#eff3f4] dark:border-slate-700 bg-white dark:bg-slate-900/70 px-4 py-3 text-[#0f1419] dark:text-white" placeholder="Declaration / reference" />
