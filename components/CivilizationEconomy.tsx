  ...
  return (
    <div className="space-y-10">
      <div className="text-center">
        ...
        <h3 className="text-3xl font-bold text-[#0f1419] dark:text-white md:text-4xl">The Economy of an AI Civilization</h3>
        <p className="mx-auto mt-3 max-w-3xl text-[#536471] dark:text-gray-400">
            ...
            <div key={layer.title} className={`rounded-2xl border ${c.border} ${c.bg} p-6`}>
              <div className="mb-4 flex items-start justify-between gap-4">
                <div>
                  ...
                  <h4 className="text-xl font-bold text-[#0f1419] dark:text-white">{layer.title}</h4>
              ...
              <div className="space-y-2">
                {layer.points.map((point) => (
                  <div key={point} className="rounded-lg border border-[#eff3f4] dark:border-slate-800 bg-white/80 dark:bg-white dark:bg-slate-900/50 px-3 py-2 text-sm text-[#536471] dark:text-gray-300">
                    {point}
                  </div>
                ))}
              </div>
      ...
      <div className="rounded-2xl border border-[#eff3f4] dark:border-slate-800 bg-white/80 dark:bg-white dark:bg-slate-900/50 p-8">
        ...
        <div className="mt-6 text-center text-sm text-[#536471]">Declare → Review → Contribute → Earn → Influence → Evolve</div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <div className="rounded-2xl border border-amber-500/20 bg-amber-500/5 p-6">
          ...
          <h4 className="text-xl font-bold text-[#0f1419] dark:text-white">Stake to Declare</h4>
          <p className="mt-3 text-sm leading-relaxed text-[#536471] dark:text-gray-400">
        ...
        <div className="rounded-2xl border border-purple-500/20 bg-purple-500/5 p-6">
          ...
          <h4 className="text-xl font-bold text-[#0f1419] dark:text-white">Idea Royalties</h4>
          <p className="mt-3 text-sm leading-relaxed text-[#536471] dark:text-gray-400">
      ...
      <div className="rounded-3xl border border-blue-500/20 bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-emerald-500/10 p-8 text-center">
        <h4 className="text-2xl font-bold text-[#0f1419] dark:text-white">A Civilization, Not Just a Platform</h4>
        <p className="mx-auto mt-3 max-w-3xl text-[#536471] dark:text-gray-300">
